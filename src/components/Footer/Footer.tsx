    ...
    <footer className='py-16 bg-neutral-100'>
      <div className='container'>
        ...
        <div className='text-center mt-20 text-xs text-[#000000a6]'>
          ...
          <div className='mt-5'>
            <span className=''>hiveshop</span>
            <div className='mt-5'>
              <p className='mt-2'>
                Địa chỉ: Tầng 4-5-6, Tòa nhà Capital Place, số 29 đường Liễu Giai, Phường Ngọc Khánh, Quận Ba Đình,
                Thành phố Hà Nội, Việt Nam. Tổng đài hỗ trợ: 19001221 - Email: cskh@hotro.hiveshop.com
              </p>
              <p className='mt-2'>
              ...
              <p className='mt-2'>© 2015 - Bản quyền thuộc về Công ty TNHH hiveshop</p>
            </div>
          </div>
        </div>
      </div>
